...
void 
MemorySetSize(void *Dst, uptr Size, u32 Value)
{
  u32 *DstByte = (u32*)(Dst);
...
void 
MemoryZeroSize(void *Dst, uptr Size)
{
  u8 *DstByte = (u8*)(Dst);
  for(uptr ByteIndex = 0;
      ByteIndex < Size;
...
#define MemoryZeroStruct(StructPtr)(MemoryZeroSize(StructPtr, sizeof(*StructPtr)))
